                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{t('contactInfo.companyInfo.name')}</p>
                    </div>
                  </div>
                </CardHeader>
                ...
                <div className="p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">{t('contactInfo.companyInfo.address')}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <AnimatedSection delay={0.2}>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <CardTitle className="text-xl text-gray-900">{t('contactInfo.contact.title')}</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-6">
            ...
            <AnimatedSection delay={0.3}>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <CardTitle className="text-xl text-gray-900">{t('contactInfo.map.title')}</CardTitle>
                </div>
                <p className="text-sm text-gray-600">{t('contactInfo.map.description')}</p>
              </CardHeader>
              <CardContent>
